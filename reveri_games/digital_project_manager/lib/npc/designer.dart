...
import 'package:digital_project_manager/util/design_sprite_sheet.dart';
...
class DesignerNPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  DesignerNPC(Vector2 position, {this.dialogFilename})
      : super(
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: DesignerSpriteSheet.idleDown,
