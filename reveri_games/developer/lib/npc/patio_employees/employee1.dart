...
class PatioEmployee1NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  PatioEmployee1NPC(Vector2 position, {this.dialogFilename})
      : super(
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: PatioEmployee1SpriteSheet.idleDown,
