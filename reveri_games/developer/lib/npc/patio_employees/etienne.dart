...
class PatioEmployee3NPC extends SimpleNPC with ObjectCollision {
  ...
  PatioEmployee3NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: PatioEmployee3SpriteSheet.simpleDirectionAnimation,
          position: position,
          width: mapTileSize * 1.3,
          height: mapTileSize * 1.6,
  ...
  void EthienneAsKey() async {
    preferences.setBool("Etienne", true);
  }

  void keyMarkerDisable() async {
    preferences.setBool("Etienne", false);
  }
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: PatioEmployee3SpriteSheet.idleDown,
