...
import 'package:developer/util/patio-employee_sprite_sheet/patio-employee2-sprite-sheet.dart';
...
class PatioEmployee2NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  PatioEmployee2NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: PatioEmployee2SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: PatioEmployee2SpriteSheet.idleDown,
