...
class AdminEmployee5NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  AdminEmployee5NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: AdminEmployee5SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: AdminEmployee5SpriteSheet.idleDown,
