...
import 'package:developer/util/admin-employees_sprite_sheet/admin-employee1-sprite-sheet.dart';
...
class AdminEmployee1NPC extends SimpleNPC with ObjectCollision {
  ...
  AdminEmployee1NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: AdminEmployee1SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: AdminEmployee1SpriteSheet.idleDown,
