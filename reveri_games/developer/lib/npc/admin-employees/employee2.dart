...
import 'package:developer/util/admin-employees_sprite_sheet/admin-employee2-sprite-sheet.dart';
...
class AdminEmployee2NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  AdminEmployee2NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: AdminEmployee2SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: AdminEmployee2SpriteSheet.idleDown,
