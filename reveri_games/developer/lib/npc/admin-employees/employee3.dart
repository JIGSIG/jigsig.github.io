...
import 'package:developer/util/admin-employees_sprite_sheet/admin-employee3-sprite-sheet.dart';
...
class AdminEmployee3NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  AdminEmployee3NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: AdminEmployee3SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: AdminEmployee3SpriteSheet.idleDown,
