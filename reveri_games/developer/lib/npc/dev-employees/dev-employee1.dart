...
import 'package:developer/util/dev-employee_sprite_sheet/dev-employee1-sprite-sheet.dart';
...
class DevEmployee1NPC extends SimpleNPC with ObjectCollision {
  ...
  DevEmployee1NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: DevEmployee1SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: DevEmployee1SpriteSheet.idleDown,
