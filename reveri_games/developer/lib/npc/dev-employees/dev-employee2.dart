...
import 'package:developer/util/dev-employee_sprite_sheet/dev-employee2-sprite-sheet.dart';
...
class DevEmploye2NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  DevEmploye2NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: DevEmployee2SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: DevEmployee2SpriteSheet.idleDown,
