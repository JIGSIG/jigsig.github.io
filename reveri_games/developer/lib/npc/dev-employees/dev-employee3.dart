...
import 'package:developer/util/dev-employee_sprite_sheet/dev-employee3-sprite-sheet.dart';
...
class DevEmployee3NPC extends SimpleNPC with ObjectCollision {
  double attack = 20;
  ...
  DevEmployee3NPC(Vector2 position, {this.dialogFilename})
      : super(
          animation: DevEmployee3SpriteSheet.simpleDirectionAnimation,
          position: position,
                ...
                DialogItem(
                  ...
                  person: Container(
                    ...
                    child: FutureBuilder<SpriteAnimation>(
                      future: DevEmployee3SpriteSheet.idleDown,
