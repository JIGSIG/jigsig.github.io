...
class CommonSpriteSheet {
  ...
  static Future<SpriteAnimation> get emoteExclamation => SpriteAnimation.load(
  ...
  static Future<SpriteAnimation> get emoteButtonA => SpriteAnimation.load(
        "player/emote_buttonA.png",
        SpriteAnimationData.sequenced(
          amount: 8,
          stepTime: 0.1,
          textureSize: Vector2(32, 32),
