...
class NPC extends GameComponent
  ...
  /// Movement speed of the NPC (pixel per second).
  double speed;

  /// Check if the NPC is interacting (pixel per second).
  ...
  /// Move Npc to direction by radAngle with dodge obstacles
  void moveFromAngleDodgeObstacles(
    ...
    var collisionX = verifyNpcTranslateCollision(
      diffBase.dx,
      0,
    );
    var collisionY = verifyNpcTranslateCollision(
      0,
      diffBase.dy,
    );
  ...
  /// Check if performing a certain translate on the npc collision occurs
  bool verifyNpcTranslateCollision(
    double translateX,
    double translateY,
  ) {
