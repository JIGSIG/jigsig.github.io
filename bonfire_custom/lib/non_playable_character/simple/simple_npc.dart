...
/// Npc with animation in all direction
class SimpleNPC extends NPC {
  /// animations of the npc
  SimpleDirectionAnimation animation;

  /// Variable that represents the speed of the npc.
  final double speed;

  /// Last position the npc was.
  late Direction lastDirection;

  /// Last horizontal position the npc was.
