...
extension SimpleNpcExtensions on SimpleNPC {
  static bool go = true;
  ...
  void simpleAttackMelee({
    ...
    if (direction == null) {
      ...
      double centerYNpc = rectToMove.rect.center.dy;
      double centerXNpc = rectToMove.rect.center.dx;

      double diffX = centerXNpc - centerXPlayer;
      double diffY = centerYNpc - centerYPlayer;
