import 'package:bonfire/object_with_interaction/interaction_object.dart';
...
/// InteractionObject with animation in all direction
class SimpleInteractionObject extends InteractionObject {
  /// animations of the InteractionObject
  SimpleDirectionAnimation animation;

  /// Variable that represents the speed of the InteractionObject.
  final double speed;

  /// Last position the InteractionObject was.
  late Direction lastDirection;

  /// Last horizontal position the InteractionObject was.
